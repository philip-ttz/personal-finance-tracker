  ...
  const [tag, setTag] = useState<string>('');
    ...
    return (
      ...
      <div className="flex flex-col justify-center items-center space-y-2 title">
        {/*<h2 className="text-m font-medium text-slate-700 text-white">Personal Finance Tracker</h2>*/}
      </div>
      <form onSubmit={handleSubmit} className="w-full mt-4 space-y-3 text-sm">
        ...
        <button className="w-full justify-center py-1 bg-blue-500/50 hover:bg-blue-600/50 active:bg-blue-700/50 rounded-md text-white " id="login" name="login" type="submit">
          Submit
        </button>
      </form>
      </>
